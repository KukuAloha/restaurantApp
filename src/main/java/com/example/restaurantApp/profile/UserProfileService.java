...
public class UserProfileService {
    ...
    private final UserProfileDataAccessService userProfileDataAccessStore;
    private final FileStore fileStore;

    @Autowired
    public UserProfileService(UserProfileDataAccessService userProfileDataAccessStore, FileStore fileStore) {
        this.userProfileDataAccessStore = userProfileDataAccessStore;
        this.fileStore = fileStore;
    }

    List<UserProfile> getUserProfiles() {
        return userProfileDataAccessStore.getUserProfiles();
    }
